...
/*************************************************************************************************************
*	initializing twi slave
*
*	Parameter : 
*				adr = Address. for the Slave (0x01 - 0xFF)
*
*************************************************************************************************************/
void init_twi_slave(uint8_t adr)
{
	TWAR= adr; //set address
...
/*************************************************************************************************************
*	InterruptServiceRoutine for received data
*************************************************************************************************************/
ISR (TWI_vect)
{
	uint8_t data=0;
	...
	switch (TW_STATUS) 							// TWI-Statusregister prüfen und nötige Aktion bestimmen
	{
		...
		{ 										// 0x80 Slave Receiver,Daten empfangen
			...
			default: {TWCR_RESET;}break;				// Übertragung beenden, warten bis zur nächsten Adressierung
